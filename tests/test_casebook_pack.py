"""Regression checks for the zenith-sim-scheduler-lab casebook."""
...
from casebook.harness import assert_expected, zenith_sim_scheduler_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_sim_scheduler_lab_summary(), assert_expected())
